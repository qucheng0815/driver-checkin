...
router.get('/qrpage', async (req, res) => {
  ...
  res.send(`
    ...
    <head>
      ...
      <style>
        body { font-family: -apple-system, sans-serif; text-align: center; padding: 40px 20px; background: #f5f7fa; }
        h1 { font-size: 24px; color: #333; margin-bottom: 8px; }
        p { color: #888; margin-bottom: 30px; }
        img { border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); }
        .url { margin-top: 20px; font-size: 14px; color: #667eea; word-break: break-all; }
      </style>
    </head>
    <body>
      <h1>🚛 司机签到系统</h1>
